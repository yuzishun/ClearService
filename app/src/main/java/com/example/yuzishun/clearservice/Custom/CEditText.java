...
//        	throw new NullPointerException("You can add drawableRight attribute in XML");
            mClearDrawable = getResources().getDrawable(R.mipmap.icon_delete_title);
        }

        mClearDrawable = zoomImage(R.mipmap.icon_delete_title, dp2px(getContext(), 10), dp2px(getContext(), 10));

        mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth()+dp2px(getContext(), 10), mClearDrawable.getIntrinsicHeight()+dp2px(getContext(), 10));

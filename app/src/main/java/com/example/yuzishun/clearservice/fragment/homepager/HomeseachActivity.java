...
import com.example.yuzishun.clearservice.activity.mainfragment_activity.ChoosetelActivity;
...
public class HomeseachActivity extends BaseActivity implements View.OnClickListener, PoiSearch.OnPoiSearchListener {
    ...
    private com.example.yuzishun.clearservice.utils.loctionUtils loctionUtils;
    ...
    ListView lv_address;
    @BindView(R.id.telfuwu_recyclerView)
    RecyclerView telfuwu_recyclerView;
    ...
    public int intiLayout() {
        return R.layout.activity_homeseach;
    }
        ...
        Observer<addressBean> observer = new Observer<addressBean>() {
            ...
            public void onNext(final addressBean addressBean) {
                if(addressBean.getCode()==200) {
                    ...
                    telAdapterbeyond = new telAdapterbeyond(HomeseachActivity.this,listYse,0);
                    LinearLayoutManager linearLayoutManager = new LinearLayoutManager(HomeseachActivity.this,LinearLayoutManager.VERTICAL,false){
        ...
        seach_edit.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if(!"".equals(s.toString())){
                    ...
                    layout_fuwu.setVisibility(View.GONE);
                    ...
                    layout_fuwu.setVisibility(View.VISIBLE);
...
//                finish();
    ...
    private void dw() {
        AlertDialog.Builder builder = new AlertDialog.Builder(HomeseachActivity.this);
        LayoutInflater inflater = LayoutInflater.from(HomeseachActivity.this);
